...
class Playback(Thread):
	def __init__(self, image: np.ndarray, frame_rate: int, skeletons_list: list, label_img: customtkinter.CTkLabel,
	             video_progressbar: customtkinter.CTkSlider, runtime: int = 0):
		super().__init__()
		self.daemon = True
